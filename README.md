*Attention: This work is based on [unreal_cv_ros](https://github.com/ethz-asl/unreal_cv_ros) from ethz-asl. Because the original work is developed on UE4.16, a relatively old version of UE. I tuned some code to make it work on UE4.27.2.*

The UnrealCV branch I choose is 4.27-stable. You need add some code just like original unreal_cv_ros does. The code is in the `CustomPluginCode.cpp` file. You can find it in the `unreal_cv_ros/content` folder.
